  ...
  return (
    <div className="container px-4 py-8 lg:px-24 font-poppin">
      ...
      <div className="container flex  justify-center items-center">
        <div className="container flex justify-center items-center">
          <div className="bg-white border border-[#585858] shadow-lg py-4 px-2 md:px-6 md:py-8 text-center">
            <div>
              <button
            ...
            <span className="font-bold text-xl text-[#012A45] text-center">
              Welcome back Providers 🙋‍♀️
            </span>
