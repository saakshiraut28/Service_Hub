  ...
  return (
    ...
    <section className="providerdetails font-poppin mb-8">
        <div className="flex flex-col md:flex-row">
            ...
            <div className="heading name text-2xl font-bold text-center md:text-justify md:pt-8 md:text-3xl xl:text-4xl">
                Full Name
            </div>
            <div className="city text-center md:text-justify md:text-base xl:text-xl xl:pb-4">
                City
            </div>
            <div className="bio m-8 mb-5 mt-1 text-justify md:ml-0 md:text-base xl:text-xl">
    ...
    <section className="mt-8 font-poppin">
        <p className="mt-2 mb-4 font-bold text-2xl text-center md:text-3xl text-[#1170B0]">Services: </p>
